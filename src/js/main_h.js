...
const app = (() => {
  ...
  function displayNotification(str, image, msg) {
  ...
  const applicationServerPublicKey = 'BOdssltDDdSmfvPj6HHWsm5TVzWaRLyX0r1XR3fHF5J-LszxIWYIP-Rwhvb8cTnFJhuCs_fZSix_BoA4MNipFS8';
